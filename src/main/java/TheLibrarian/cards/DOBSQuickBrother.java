...
public class DOBSQuickBrother extends AbstractDynamicCard {
    public static final String ID = TheLibrarianMod.makeID(DOBSQuickBrother.class.getSimpleName());
