...
public class WellcheerOddCan extends AbstractDynamicCard {
    ...
    public static final String ID = TheLibrarianMod.makeID(WellcheerOddCan.class.getSimpleName());
