...
@AutoAdd.Ignore
public class VisionsOfSinners extends AbstractDynamicCard {
    ...
    public static final String ID = TheLibrarianMod.makeID(VisionsOfSinners.class.getSimpleName());
