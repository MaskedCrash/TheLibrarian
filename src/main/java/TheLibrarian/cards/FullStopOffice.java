...
public class FullStopOffice extends CustomCard {

    /*
     * Wiki-page: https://github.com/daviscook477/BaseMod/wiki/Custom-Cards
     *
     * Full Stop - Deal 8(13), Inflict 1 Weak
     * Invitation (4 Attacks): Inflict 2 Weak
     */

    // TEXT DECLARATION

    public static final String ID = TheLibrarianMod.makeID(FullStopOffice.class.getSimpleName());
    ...
    // The list of all of them can be found in the main TheLibrarian.java file in the
    ...
    private static final int MAGIC_PLUS = 1;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom( // The action managed queues all the actions a card should do.
                ...
                new DamageAction(m, new DamageInfo(p, damage, damageTypeForTurn),
                        ...
                        AbstractGameAction.AttackEffect.BLUNT_LIGHT)); // The animation the damage action uses to hit.
        addToBot((AbstractGameAction)new ApplyPowerAction(m, p, new WeakPower(m, this.magicNumber, false), 1));
        //Check list of played cards this combat
        Set<String> played = new HashSet<String>();

        if(invitationCheck(4,0,0)){
            addToBot((AbstractGameAction)new ApplyPowerAction(m, p, new WeakPower(m, this.magicNumber, false), magicNumber));
        }
