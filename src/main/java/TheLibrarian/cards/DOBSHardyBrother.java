...
public class DOBSHardyBrother extends AbstractDynamicCard {
    public static final String ID = TheLibrarianMod.makeID(DOBSHardyBrother.class.getSimpleName());
