...
public class WellcheerPurpleCan extends AbstractDynamicCard {
    ...
    public static final String ID = TheLibrarianMod.makeID(WellcheerPurpleCan.class.getSimpleName());
    ...
    public void onChoseThisOption() {
        AbstractDungeon.actionManager.addToBottom(new ObtainPotionAction(new RegenPotion()));
    }
