...
@AutoAdd.Ignore
public class LessonsOfTheSephirot extends AbstractDynamicCard {
    ...
    public static final String ID = TheLibrarianMod.makeID(LessonsOfTheSephirot.class.getSimpleName());
