...
public class LightFormPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public LightFormPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new LightFormPower(owner, source, amount);
    }
}
