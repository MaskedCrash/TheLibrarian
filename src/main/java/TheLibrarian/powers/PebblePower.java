...
public class PebblePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public PebblePower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void onVictory() {
        for (int i = 0; i < this.amount; i++)
            AbstractDungeon.getCurrRoom().addCardReward((RewardItem)new RewardItem());
    }

    @Override
    public AbstractPower makeCopy() {
        return new PebblePower(owner, source, amount);
    }
}
