...
public class LampPowerEnemy extends AbstractPower
{
    public static final String POWER_ID = "LampLured";
    ...
    public LampPowerEnemy(AbstractMonster owner)
    {
        this(owner, 1);
    }

    public LampPowerEnemy   (AbstractMonster owner, int amount)
    {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
            ...
            public void update()
            {
                if (owner instanceof AbstractMonster) {
                    ...
                    try {
                        ...
                        EnemyMoveInfo attackMove = new EnemyMoveInfo(moveByte, AbstractMonster.Intent.ATTACK, 12, 0, false);
                        f.set(owner, attackMove);
